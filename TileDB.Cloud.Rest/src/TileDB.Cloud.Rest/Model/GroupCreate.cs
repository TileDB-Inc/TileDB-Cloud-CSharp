...
namespace TileDB.Cloud.Rest.Model
{
    ...
    public partial class GroupCreate : IEquatable<GroupCreate>, IValidatableObject
    {
        /// <summary>
        ...
        public GroupCreate(string description = default(string), string name = default(string), string parent = default(string), string uri = default(string), string logo = default(string), string accessCredentialsName = default(string), List<string> tags = default(List<string>), string licenseId = default(string), string licenseText = default(string))
        {
        ...
        {
            return this.Equals(input as GroupCreate);
        }

        /// <summary>
        /// Returns true if GroupCreate instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupCreate input)
        {
            if (input == null)
            {
                return false;
