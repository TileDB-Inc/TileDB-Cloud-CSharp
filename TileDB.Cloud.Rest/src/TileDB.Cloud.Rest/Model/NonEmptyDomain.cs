...
namespace TileDB.Cloud.Rest.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NonEmptyDomain")]
    public partial class NonEmptyDomain : IEquatable<NonEmptyDomain>, IValidatableObject
    {
        ...
        public NonEmptyDomain(DomainArray nonEmptyDomain = default(DomainArray), bool isEmpty = default(bool))
        {
            ...
            {
                throw new ArgumentNullException("nonEmptyDomain is a required property for NonEmptyDomain and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "nonEmptyDomain", IsRequired = true, EmitDefaultValue = false)]
