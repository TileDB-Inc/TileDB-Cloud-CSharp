...
namespace TileDB.Cloud.Rest.Model
{
    ...
    public partial class ArraySchema : IEquatable<ArraySchema>, IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name = "arrayType", IsRequired = true, EmitDefaultValue = false)]
        ...
        public ArraySchema(string uri = default(string), List<int> version = default(List<int>), ArrayType arrayType = default(ArrayType), Layout tileOrder = default(Layout), Layout cellOrder = default(Layout), int capacity = default(int), FilterPipeline coordsFilterPipeline = default(FilterPipeline), FilterPipeline offsetFilterPipeline = default(FilterPipeline), Domain domain = default(Domain), List<Attribute> attributes = default(List<Attribute>), bool allowsDuplicates = default(bool))
        {
            ...
            if (version == null)
            {
                throw new ArgumentNullException("version is a required property for ArraySchema and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("coordsFilterPipeline is a required property for ArraySchema and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("offsetFilterPipeline is a required property for ArraySchema and cannot be null");
            }
            this.OffsetFilterPipeline = offsetFilterPipeline;
            // to ensure "domain" is required (not null)
            if (domain == null)
            {
                throw new ArgumentNullException("domain is a required property for ArraySchema and cannot be null");
            }
            this.Domain = domain;
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new ArgumentNullException("attributes is a required property for ArraySchema and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "coordsFilterPipeline", IsRequired = true, EmitDefaultValue = false)]
        public FilterPipeline CoordsFilterPipeline { get; set; }

        /// <summary>
        /// Gets or Sets OffsetFilterPipeline
        /// </summary>
        [DataMember(Name = "offsetFilterPipeline", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "allowsDuplicates", EmitDefaultValue = true)]
