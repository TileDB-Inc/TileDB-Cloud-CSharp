...
namespace TileDB.Cloud.Rest.Model
{
    ...
    public partial class Organization : IEquatable<Organization>, IValidatableObject
    {
        ...
        public Organization(string id = default(string), OrganizationRoles? role = default(OrganizationRoles?), string name = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), string logo = default(string), string description = default(string), List<OrganizationUser> users = default(List<OrganizationUser>), List<NamespaceActions> allowedActions = default(List<NamespaceActions>), decimal numOfArrays = default(decimal), string defaultS3Path = default(string), string defaultS3PathCredentialsName = default(string), AssetLocations assetLocations = default(AssetLocations))
        {
