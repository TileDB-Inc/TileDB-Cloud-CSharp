...
namespace TileDB.Cloud.Rest.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UDFSharing")]
    public partial class UDFSharing : IEquatable<UDFSharing>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UDFSharing" /> class.
        /// </summary>
        ...
        public UDFSharing(List<UDFActions> actions = default(List<UDFActions>), string _namespace = default(string), string namespaceType = default(string))
        {
        ...
        public List<UDFActions> Actions { get; set; }
        ...
        {
            return this.Equals(input as UDFSharing);
        }

        /// <summary>
        /// Returns true if UDFSharing instances are equal
        /// </summary>
        /// <param name="input">Instance of UDFSharing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UDFSharing input)
        {
            if (input == null)
            {
                return false;
