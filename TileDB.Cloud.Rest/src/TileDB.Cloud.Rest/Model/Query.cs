...
namespace TileDB.Cloud.Rest.Model
{
    ...
    public partial class Query :  IEquatable<Query>, IValidatableObject
    {
        ...
        public Query(Querytype type = default(Querytype), Layout layout = default(Layout), Querystatus status = default(Querystatus), List<AttributeBufferHeader> attributeBufferHeaders = default(List<AttributeBufferHeader>), Writer writer = default(Writer), QueryReader reader = default(QueryReader), Array array = default(Array), int totalFixedLengthBufferBytes = default(int), int totalVarLenBufferBytes = default(int))
        {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for Query and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (layout == null)
            {
                throw new InvalidDataException("layout is a required property for Query and cannot be null");
            }
            else
            {
                this.Layout = layout;
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for Query and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            {
                throw new InvalidDataException("attributeBufferHeaders is a required property for Query and cannot be null");
            }
            else
            {
            ...
            if (array == null)
            {
                throw new InvalidDataException("array is a required property for Query and cannot be null");
            }
            else
            {
                this.Array = array;
            ...
            // to ensure "totalFixedLengthBufferBytes" is required (not null)
            if (totalFixedLengthBufferBytes == null)
            {
                throw new InvalidDataException("totalFixedLengthBufferBytes is a required property for Query and cannot be null");
            }
            else
            {
            ...
            // to ensure "totalVarLenBufferBytes" is required (not null)
            if (totalVarLenBufferBytes == null)
            {
                throw new InvalidDataException("totalVarLenBufferBytes is a required property for Query and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="attributeBufferHeaders", EmitDefaultValue=true)]
        ...
        [DataMember(Name="totalFixedLengthBufferBytes", EmitDefaultValue=true)]
        ...
        [DataMember(Name="totalVarLenBufferBytes", EmitDefaultValue=true)]
        ...
        public bool Equals(Query input)
        {
            ...
            return 
                ...
                (
                    ...
                    (this.TotalFixedLengthBufferBytes != null &&
                ...
                (
                    ...
                    (this.TotalVarLenBufferBytes != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TotalFixedLengthBufferBytes != null)
                    hashCode = hashCode * 59 + this.TotalFixedLengthBufferBytes.GetHashCode();
                if (this.TotalVarLenBufferBytes != null)
