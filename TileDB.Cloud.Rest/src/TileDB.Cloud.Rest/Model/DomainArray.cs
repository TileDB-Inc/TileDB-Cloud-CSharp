...
namespace TileDB.Cloud.Rest.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DomainArray")]
    public partial class DomainArray : IEquatable<DomainArray>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DomainArray" /> class.
        /// </summary>
        ...
        public DomainArray(List<int> int8 = default(List<int>), List<int> uint8 = default(List<int>), List<int> int16 = default(List<int>), List<int> uint16 = default(List<int>), List<int> int32 = default(List<int>), List<int> uint32 = default(List<int>), List<long> int64 = default(List<long>), List<int> uint64 = default(List<int>), List<float> float32 = default(List<float>), List<double> float64 = default(List<double>))
        {
            this.Int8 = int8;
            this.Uint8 = uint8;
            this.Int16 = int16;
        ...
        public List<int> Uint32 { get; set; }
        ...
        {
            return this.Equals(input as DomainArray);
        }

        /// <summary>
        /// Returns true if DomainArray instances are equal
        /// </summary>
        /// <param name="input">Instance of DomainArray to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DomainArray input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    ...
                    this.Int8 != null &&
                    input.Int8 != null &&
                    this.Int8.SequenceEqual(input.Int8)
                ) && 
                (
                    this.Uint8 == input.Uint8 ||
                    this.Uint8 != null &&
                    input.Uint8 != null &&
                    this.Uint8.SequenceEqual(input.Uint8)
                ) && 
                (
                    this.Int16 == input.Int16 ||
                    this.Int16 != null &&
                    input.Int16 != null &&
                    this.Int16.SequenceEqual(input.Int16)
                ) && 
                (
                    this.Uint16 == input.Uint16 ||
                    this.Uint16 != null &&
                    input.Uint16 != null &&
                    this.Uint16.SequenceEqual(input.Uint16)
                ) && 
                (
                    this.Int32 == input.Int32 ||
                    this.Int32 != null &&
                    input.Int32 != null &&
                    this.Int32.SequenceEqual(input.Int32)
                ) && 
                (
                    this.Uint32 == input.Uint32 ||
                    this.Uint32 != null &&
                    input.Uint32 != null &&
                    this.Uint32.SequenceEqual(input.Uint32)
                ) && 
                (
                    this.Int64 == input.Int64 ||
                    this.Int64 != null &&
                    input.Int64 != null &&
                    this.Int64.SequenceEqual(input.Int64)
                ) && 
                (
                    this.Uint64 == input.Uint64 ||
                    this.Uint64 != null &&
                    input.Uint64 != null &&
                    this.Uint64.SequenceEqual(input.Uint64)
                ) && 
                (
                    this.Float32 == input.Float32 ||
                    this.Float32 != null &&
                    input.Float32 != null &&
                    this.Float32.SequenceEqual(input.Float32)
                ) && 
                (
                    this.Float64 == input.Float64 ||
                    this.Float64 != null &&
                    input.Float64 != null &&
                    this.Float64.SequenceEqual(input.Float64)
                );
        }
