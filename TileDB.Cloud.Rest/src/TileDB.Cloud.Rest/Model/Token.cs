...
namespace TileDB.Cloud.Rest.Model
{
    ...
    public partial class Token : IEquatable<Token>, IValidatableObject
    {
        ...
        public Token(string token = default(string), string name = default(string), DateTime issuedAt = default(DateTime), DateTime expiresAt = default(DateTime), List<TokenScope> scope = default(List<TokenScope>))
        {
            this._Token = token;
            this.Name = name;
