...
namespace TileDB.Cloud.Rest.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DimensionCoordinate")]
    public partial class DimensionCoordinate : IEquatable<DimensionCoordinate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DimensionCoordinate" /> class.
        /// </summary>
        ...
        public DimensionCoordinate(int int8 = default(int), int uint8 = default(int), int int16 = default(int), int uint16 = default(int), int int32 = default(int), int uint32 = default(int), long int64 = default(long), int uint64 = default(int), float float32 = default(float), double float64 = default(double))
        {
            this.Int8 = int8;
            this.Uint8 = uint8;
            this.Int16 = int16;
        ...
        {
            return this.Equals(input as DimensionCoordinate);
        }

        /// <summary>
        /// Returns true if DimensionCoordinate instances are equal
        /// </summary>
        /// <param name="input">Instance of DimensionCoordinate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DimensionCoordinate input)
        {
            if (input == null)
            {
                return false;
