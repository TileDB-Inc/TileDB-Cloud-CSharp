...
namespace TileDB.Cloud.Rest.Model
{
    ...
    public partial class Invitation :  IEquatable<Invitation>, IValidatableObject
    {
        ...
        public Invitation(string id = default(string), InvitationType? invitationType = default(InvitationType?), string ownerNamespaceUuid = default(string), string userNamespaceUuid = default(string), string organizationUserUuid = default(string), string organizationName = default(string), OrganizationRoles? organizationRole = default(OrganizationRoles?), string arrayUuid = default(string), string arrayName = default(string), string email = default(string), string actions = default(string), InvitationStatus? status = default(InvitationStatus?), DateTime createdAt = default(DateTime), DateTime expiresAt = default(DateTime), DateTime acceptedAt = default(DateTime))
        {
            this.Id = id;
