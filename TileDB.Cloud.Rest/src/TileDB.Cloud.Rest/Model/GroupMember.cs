...
namespace TileDB.Cloud.Rest.Model
{
    ...
    public partial class GroupMember : IEquatable<GroupMember>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="_namespace">The namespace of the asset..</param>
        /// <param name="name">The name or id of the asset..</param>
        /// <param name="memberType">memberType.</param>
        public GroupMember(string _namespace = default(string), string name = default(string), GroupMemberType? memberType = default(GroupMemberType?))
        {
        ...
        /// </summary>
        /// <value>The namespace of the asset.</value>
        ...
        /// </summary>
        /// <value>The name or id of the asset.</value>
