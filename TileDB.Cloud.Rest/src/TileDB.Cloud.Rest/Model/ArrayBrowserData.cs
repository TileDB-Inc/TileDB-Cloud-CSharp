...
namespace TileDB.Cloud.Rest.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ArrayBrowserData")]
    public partial class ArrayBrowserData : IEquatable<ArrayBrowserData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArrayBrowserData" /> class.
        /// </summary>
        /// <param name="arrays">Array Info.</param>
        /// <param name="paginationMetadata">paginationMetadata.</param>
        public ArrayBrowserData(List<ArrayInfo> arrays = default(List<ArrayInfo>), PaginationMetadata paginationMetadata = default(PaginationMetadata))
        {
            this.Arrays = arrays;
        ...
        {
            return this.Equals(input as ArrayBrowserData);
        }

        /// <summary>
        /// Returns true if ArrayBrowserData instances are equal
        /// </summary>
        /// <param name="input">Instance of ArrayBrowserData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ArrayBrowserData input)
        {
            if (input == null)
            {
                return false;
