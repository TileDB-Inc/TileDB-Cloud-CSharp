...
namespace TileDB.Cloud.Rest.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TGSQLNodeData")]
    public partial class TGSQLNodeData : IEquatable<TGSQLNodeData>, IValidatableObject
    {
        ...
        /// <param name="_namespace">If set, the non-default namespace to execute this SQL query under. .</param>
        public TGSQLNodeData(List<string> initCommands = default(List<string>), string query = default(string), List<Object> parameters = default(List<Object>), ResultFormat? resultFormat = default(ResultFormat?), string _namespace = default(string))
        {
        ...
        /// </summary>
        /// <value>If set, the non-default namespace to execute this SQL query under. </value>
