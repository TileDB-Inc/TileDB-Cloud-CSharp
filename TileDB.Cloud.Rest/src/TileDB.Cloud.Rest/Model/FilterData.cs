...
namespace TileDB.Cloud.Rest.Model
{
    ...
    /// Filter data
    /// </summary>
    [DataContract(Name = "Filter_data")]
    public partial class FilterData : IEquatable<FilterData>, IValidatableObject
    {
        /// <summary>
        ...
        public FilterData(int int8 = default(int), int uint8 = default(int), int int16 = default(int), int uint16 = default(int), int int32 = default(int), int uint32 = default(int), long int64 = default(long), int uint64 = default(int), int float32 = default(int), int float64 = default(int))
        {
            this.Int8 = int8;
            this.Uint8 = uint8;
            this.Int16 = int16;
        ...
        {
            return this.Equals(input as FilterData);
        }

        /// <summary>
        /// Returns true if FilterData instances are equal
        /// </summary>
        /// <param name="input">Instance of FilterData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FilterData input)
        {
            if (input == null)
            {
                return false;
