...
${nuget_cmd} install src/TileDB.Cloud.Rest/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/TileDB.Cloud.Rest.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/TileDB.Cloud.Rest.dll \
-recurse:'src/TileDB.Cloud.Rest/*.cs' \
-doc:bin/TileDB.Cloud.Rest.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/TileDB.Cloud.Rest.dll was created successfully"
fi
